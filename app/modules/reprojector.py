...
# Built in Session 07: the real reprojection, alignment, and clipping
# logic that forces every factor layer onto one shared grid. Reused
# directly in Session 09 (web map CRS) and by app.py's live pipeline.
